...
road_cross = input('You\'re at a cross road. '
                   'Where do you want to go? Type "left" or "right"\n')
if road_cross == "Left" or road_cross == "left":
...
elif road_cross == "Right" or road_cross == "right":
    print("You fell into a hole. Game Over.")
else:
    print("You chose a path that doesn't exits. Game Over.")
